...
enum {PTAB_FRONT = 0, PTAB_GAME_SETTINGS, PTAB_2D, PTAB_3D, /* PTAB_TEXTURE, */ PTAB_EDITOR, /* PTAB_MOUSE, */
      PTAB_EDITING, PTAB_STARTUP, PTAB_PATHS, PTAB_BRUSH, PTAB_SHADERS, PTAB_BSPMONITOR} pref_tabs;
